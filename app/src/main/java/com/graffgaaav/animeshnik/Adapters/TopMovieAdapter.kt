...
class TopMovieAdapter(val companies: ArrayList<TopMovie>, var listener: Clicker, var context: Context): RecyclerView.Adapter<TopMovieAdapter.ViewHolder>() {


    interface Clicker{
        fun OnClick(company: TopMovie)
    }

    interface longClicker{
        fun onItemLongClicked(company: TopMovie): Boolean
    }
...
//            .into(p0.imageLogo)
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun insertAddons(companies: TopMovie, listener: Clicker){
